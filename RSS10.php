...
/**
 * @file RSS10.php
 * @brief RSS 1.0 classes.
 * 
 * Contains FeedParserRSS10 and FeedParserRSS10Element.
 */

/**
 * @brief Handles RSS 1.1 feeds. 
 *
 * Here is a place where we get if in FeedParser we've detected that feed is 
 * RSS 1.0.
 *
 * RSS 1.0 is documented at http://web.resource.org/rss/1.0/spec
 *
 ...
 */
class FeedParserRSS10 extends FeedParser implements IFeed
{
	...
	/**
	 * Return link that holds RSS10 feed itself.
	 * 
	 * Unlike Atom feeds, RSS10 feeds don't have any special tag or anything else 
	 * for that purpose.
	 *
	...
	/**
	 * Return description for RSS10 feed. Description is containing in 
	...
	/**
	 *	Fetch items from feed as array of FeedParserRSS10Element objects.
	 *	
	 ...
	 *
	 *	@return 
	 *	    Array of FeedParserRSS10Element class instances
	 */
	public function getItems()
	{
		...
		foreach($entries as $entry)
		{
			...
			$items[] = new FeedParserRSS10Element($doc);
		}
...
/**
 * @brief Handles RSS 1.0 feed items.
 *
 * This class represents RSS 1.0 <item> node. We make array of this class 
 * instances in FeedParserRSS10::getItems() .
 *
 * This class implements IItem interface.
 *
 * @author  Alex Dzyoba <finger@reduct.ru>
 */
class FeedParserRSS10Element implements IItem
{
	/** 
