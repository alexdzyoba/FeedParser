...
/**
 * @file RSS11.php
 * @brief RSS 1.1 classes.
 * 
 * Contains FeedParserRSS11 and FeedParserRSS11Element.
 */
 ...
 * RSS 1.1.
 *
 * RSS 1.1 is documented at http://inamidst.com/rss1.1/ 
 *
 ...
 */
class FeedParserRSS11 extends FeedParser implements IFeed
{
	 ...
	 *
	 *	@return 
	 *	    Array of FeedParserRSS11Element class instances
	 */
	public function getItems()
	{
		...
		foreach($entries as $entry)
		{
			...
			$items[] = new FeedParserRSS11Element($doc);
		}
...
/**
 * @brief Handles RSS 1.1 feed items. 
 *
 * This class represents RSS 1.1 <item> node. We make array of this class 
 * instances in FeedParserRSS11::getItems() .
 *
 * This class implements IItem interface.
 *
 * @author  Alex Dzyoba <finger@reduct.ru>
 */
class FeedParserRSS11Element implements IItem
{
	/** 
